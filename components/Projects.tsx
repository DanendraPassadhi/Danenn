...
export function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "A Flutter-based UI clone of the Jawara Pintar website for neighborhood management.",
      image: `${baseUrl}jawara.png`,
      tags: ["Team Project", "Flutter", "Dart"],
    ...
    },
    {
      ...
      title: "JAWARA Apps",
      description:
        "A feature-rich Flutter app for neighborhood management with Firebase and AI integration, designed to streamline community interactions and administrative tasks.",
      image: `${baseUrl}jawaraApps.png`,
      tags: ["Team Project", "Flutter", "Dart", "OCR", "Machine Learning", "Firebase", "Google Gemini API"],
      github: null,
      figma: null,
      demo: null,
      type: "github" as const,
